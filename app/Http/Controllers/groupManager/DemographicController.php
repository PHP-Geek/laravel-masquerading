...
class DemographicController extends Controller {
    ...
    function templates() {
        ...
        return view('groupManager.demographics.templates')->with($data);
    }
    ...
    function createTemplate(Request $request) {
        ...
        return view('groupManager.demographics.createTemplate')->with($data);
    }
...
//        dd(Session)
        ...
        return view('groupManager.demographics.index')->with($data);
    }
...
//                dd($request->requestArr);
    ...
    function save(Request $request) {
        if ($request->method() == 'POST') {
            ...
            if ($traitUploadResult == '1') {
                ...
                return redirect('/group-manager/trait')->with('requestArr', $request->toArray());
            } else if ($traitUploadResult == '0') {
                \Session::flash('error', 'Something went wrong');
                return redirect('/group-manager/trait')->with('requestArr', $request);
            } else {
        ...
        \Session::flash('error', 'Something went wrong');
        return redirect('/groupManager/trait')->with('requestArr', $request);
    }
    ...
    function create(Request $request) {
        ...
        return view('groupManager.demographics.create')->with($data);
    }
