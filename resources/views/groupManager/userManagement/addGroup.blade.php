                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select  class="form-control" id="groupManagerId" name="groupManagerId" >
                                                                        <option value="" selected="selected">Select Group Manager</option>
                                                                        @foreach($groupManagers as $groupManager)
                                                                        <option value="{{$groupManager->id}}" {{(isset($groupDetail->groupManagerId) && $groupDetail->groupManagerId == $groupManager->id) ? 'selected="selected"':''}}>{{$groupManager->firstName.' '.$groupManager->lastName}}</option>   
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
...
<script src="{{url('/js/groupManager/userManagement/addGroup.js')}}"></script>
@endsection