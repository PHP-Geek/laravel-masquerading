                ...
                <div class="page-content">
                    <div class="container">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="{{url('/group-manager/session/list')}}">Sessions</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <a href="{{url('/group-manager/session/list/participants/'.$sessionArray->id)}}">Lists</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span>create</span>
							...
							<div class="col-md-12">
								...
								<div class="table-responsive">
									...
									<tbody>
									    ...
									    @foreach($listArray->listParticipant as $key => $listParticipant)
									    <tr id="row_{{ $listParticipant->id }}">
										<td>{{ $key+1 }}</td>
										...
										<td><a href="javascript:;" onclick="deleteParticipant(this)" data-value="{{ $listParticipant->id }}"><i class="fa fa-trash text-danger"><i></a></td>  
												...
												<div id="importParticipantModal" class="modal fade" role="dialog">
													...
													<div class="modal-content">
                                                                                                            ...
                                                                                                            <form id="importParticipantForm" method="POST" action="{{url('/group-manager/session/list/import')}}" enctype="multipart/form-data">
                                                                                                                {{ csrf_field() }}
												...
												<script src="{{url('/js/groupManager/lists/participants.js')}}"></script>
												@endsection