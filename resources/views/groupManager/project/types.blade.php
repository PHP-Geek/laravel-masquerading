                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption caption-md pull-right ">
                                            <a type="button" href="{{url('/group-manager/project/project-type/add')}}" class="btn btn-orange text-white"><i class="fa fa-plus-circle"></i> Add Project Type </a>
                                        </div>
                                    </div>
						...
						<div class="row">
							...
							<div class="dataTables_length pull-right margin-top-20" id="sample_5_length" style="max-width: 300px;">
								...
								<span class="input-group-btn">
								    ...
								    <button class="btn green-jungle text-white" type="button" id="resetBtn">
...
<script type="text/javascript" src="{{url('/js/groupManager/projects/types.js')}}"></script>
@endsection
