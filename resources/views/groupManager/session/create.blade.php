                ...
                <div class="page-content">
                    <div class="container">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span><a href="{{url('/group-manager/session/list')}}">Sessions</a></span>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span>{{isset($sessionDetail) && ($sessionDetail->id > 0) > 0 ? 'Edit':'Create'}}</span>
                            </li>
                        </ul>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>Participant List &nbsp &nbsp<div class="caption caption-md pull-right">
                                                                        ...
                                                                        </div></label>                                                                    <select class="form-control" name="sessionListId" id="sessionListId">
...
<script src="{{url('/js/groupManager/sessions/create.js')}}"></script>
@endsection