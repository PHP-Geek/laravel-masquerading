                ...
                <div class="page-content">
                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        <div class="caption caption-md">
                                            ...
                                            <span class="caption-subject font-red-sunglo uppercase bold">Projects</span>                </div>
					<div class="caption caption-md pull-right">
					    <a href="javascript:;" onclick="addProject()" class="btn btn-orange text-white"><i class="fa fa-plus-circle"></i> Add New</a>
					</div>
                                    </div>
					...
					<div class="col-sm-12">
						...
						<div class="row">
							...
							<select class="form-control" id="groupName" name="groupName" ></select>
...
<script src="{{url('/js/admin/projects/lists.js')}}"></script>
@endsection
