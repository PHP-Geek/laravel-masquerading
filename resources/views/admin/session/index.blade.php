                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption caption-md pull-right">
                                            <a href="javascript:;" onclick="addSession()" class="btn btn-orange text-white"><i class="fa fa-plus-circle"></i> Add New</a>
                                        </div>
                                    </div>
				    <div class="row">
					<div class="col-sm-12">
									    ...
									    <div class="row">
										   <div class="col-md-2 col-sm-12">
											...
											<div id="sample_5_filter" class="dataTables_filter input-group">
											    <input type="text" name="keyword" id="keyword" class="form-control" style="height: 34px" placeholder="Project">
...
<script src="{{url('/js/admin/sessions/index.js')}}"></script>
@endsection
