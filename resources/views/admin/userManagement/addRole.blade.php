                                                ...
                                                <div class="portlet light">
                                                    <div class="portlet-title">
                                                        ...
                                                        <div class="caption caption-md pull-right">
                                                            <a type="button" class="btn btn-orange text-white" data-toggle="modal" href="#basic5"> Add Role</a>
                                                        </div>
                                                    </div>
                                                     <div class="row">
                                                         <div class="col-md-12 col-sm-12">
                                                            ...
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td> <a href="" type="button" class="btn green-jungle btn-outline"><i class="fa fa-eye"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-orange">Add Role</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    <div class="modal fade" id="basic4" tabindex="-1" role="basic4" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h3 class="modal-title text-center"><b>Reset Password</b></h3>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
