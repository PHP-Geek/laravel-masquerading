        ...
        <form class="login-form" action="index.php" method="post">
            ...
            <div class="form-actions">
                <label class="rememberme mt-checkbox mt-checkbox-outline">
                    <input type="checkbox" name="remember" value="1" /> <h4 class="font-white margin-top-0 sbold">Remember me</h4>
                    <span></span>
                </label>
            ...
            <div class="forget-password">
                ...
                <p class="font-white"> no worries, click
                    <a href="javascript:;" id="forget-password" class="font-white sbold"> here </a> to reset your password. </p>
            </div>
            <div class="create-account">
                <p class="font-white"> Don't have an account yet ?&nbsp;
                    <a href="javascript:;" id="register-btn" class="font-white sbold"> Create an account </a>
                </p>
            </div>
        </form>
        <!-- END LOGIN FORM -->
