...
<!--                                                                            <i class="icon-settings font-red-sunglo"></i>-->
                                                            <span class="caption-subject font-red-sunglo bold uppercase"> Edit Detail</span>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <p class="help-block font-white"> Upload Company Logo </p>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Package 123">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <p class="margin-bottom-5 font-dark">Company Colors</p>
                                                                        <div class="form-group">
                                                                            <label class="control-label visible-ie8 visible-ie9"></label>
                                                                            <div class="input-icon">
                                                                                <i class="fa fa-paint-brush"></i>
                                                                                <input type="color" id="position-top-left" class="form-control demo" placeholder="Company Colors" name="colors" data-position="top left" value="color"> 
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
