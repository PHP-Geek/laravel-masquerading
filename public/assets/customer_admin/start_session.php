                                                ...
                                                <div class="portlet light">
                                                    <div class="portlet-title">
                                                        <div class="caption caption-md">
                                                            ...
                                                            <span class="caption-subject font-red-sunglo uppercase bold">Sessions</span>
                                                            ...
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td> <a class="btn yellow btn-outline mt-sweetalert swtalertt">Start Session</a></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td> 2 </td>
                                                                        <td> Myuito</td>
                                                                        ...
                                                                        <td> Sertyu</td>
                                                                        <td> Transcript - <span class="clr-green"><b> Completed</b> </span></td>
                                                                        <td> <a class="btn red btn-outline mt-sweetalert swtalert">Stop Session</a></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td> 3 </td>
                                                                        <td> Sertyiu </td>
