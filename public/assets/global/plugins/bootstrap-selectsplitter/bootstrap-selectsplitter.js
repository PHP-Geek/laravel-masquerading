+function ($) {
  'use strict';
    ...
    SelectSplitter.prototype.init = function (type, element, options) {
        ...
        self.$wrapper = self.$element.next('div[data-selectsplitter-wrapper-selector]');
        self.$firstSelect = $('select[data-selectsplitter-firstselect-selector]', self.$wrapper);
        self.$secondSelect = $('select[data-selectsplitter-secondselect-selector]', self.$wrapper); 
