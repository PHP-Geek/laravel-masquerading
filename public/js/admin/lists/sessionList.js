...
function participants(id) {
    window.location.href = base_url + '/admin/session/list/participant/' + id + '/' + curData.sessionId;
}
    ...
    swal({
        ...
        function (res) {
            if (res) {
                ...
                $.post(base_url + '/admin/session/change-session-list', {
...
function editList(id) {
    $.get(base_url + '/admin/session/list/get-list/' + id, function (result) {
...
$("#addListForm").validate({
    ...
    submitHandler: function (form) {
        ...
        $.post(base_url + "/admin/session/list/save", $("#addListForm").serialize(), function (data) {
            if (data.code == '1') {
                swal({
                    title: '',
                    text: 'Success',
